...
#define FRSKY_PT_SENSOR_ID_STATUS_TEXT         FRSKY_PT_SENSOR_ID_DIY
#define FRSKY_PT_SENSOR_ID_AP_STATUS           FRSKY_PT_SENSOR_ID_DIY + 1
#define FRSKY_PT_SENSOR_ID_GPS_STATUS          FRSKY_PT_SENSOR_ID_DIY + 2
#define FRSKY_PT_SENSOR_ID_GPS_LAT             FRSKY_SENSOR_ID_GPS_LONG_LATI_FIRST
#define FRSKY_PT_SENSOR_ID_GPS_LON             FRSKY_SENSOR_ID_GPS_LONG_LATI_FIRST + 1
#define FRSKY_PT_SENSOR_ID_BATTERY_1           FRSKY_PT_SENSOR_ID_DIY + 3
#define FRSKY_PT_SENSOR_ID_HOME                FRSKY_PT_SENSOR_ID_DIY + 4
#define FRSKY_PT_SENSOR_ID_VEL_YAW             FRSKY_PT_SENSOR_ID_DIY + 5
#define FRSKY_PT_SENSOR_ID_ATT_RNG             FRSKY_PT_SENSOR_ID_DIY + 6
#define FRSKY_PT_SENSOR_ID_PARAMETERS          FRSKY_PT_SENSOR_ID_DIY + 7
#define FRSKY_PT_SENSOR_ID_BATTERY_2           FRSKY_PT_SENSOR_ID_DIY + 8
#define FRSKY_PT_SENSOR_ID_WAYPOINTS_MISSIONS  FRSKY_PT_SENSOR_ID_DIY + 9
